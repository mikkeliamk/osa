  ...
  */
  ...
  DragAndDropHandler = (function() {
    ...
    DragAndDropHandler.prototype.updateDropHint = function() {
      ...
      var level = this.hovered_area.node.getLevel();
      var level = level - 1;
      
      if(this.hovered_area.node.type == "C"){
          ...
          $.ajax({
          	...
          	success: function(j) {
	            if(j == "true"){
	          	  $('.jqtree-dragging').css("cursor", "pointer");
	        	  $('.jqtree-dragging').css("background", "#000");
	            }else{
	          	  $('.jqtree-dragging').css("cursor", "not-allowed");
	        	  $('.jqtree-dragging').css("background", "#ff0000");
	            }
          	}
          });	
    	  
      }else if(this.hovered_area.node.type == null){
    	  $('.jqtree-dragging').css("cursor", "default");
    	  $('.jqtree-dragging').css("background", "#000");
      }else{
    	  $('.jqtree-dragging').css("cursor", "not-allowed");
    	  $('.jqtree-dragging').css("background", "#ff0000");
